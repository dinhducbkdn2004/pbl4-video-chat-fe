...
const SearchPage = () => {
    ...
    return (
        <div className='flex h-screen flex-col pl-2 md:flex-row'>
            {/* Mobile menu toggle */}
            {isMobile && (
                <div className='sticky top-0 z-20 flex h-[50px] items-center justify-between rounded-lg bg-white-default px-4 dark:bg-black-light'>
                    <h2 className='text-lg font-bold text-blue'>Search</h2>
                    <MenuOutlined
